...
const char *gengetopt_args_info_help[] = {
  ...
  "  -h, --host       Be the host  (default=on)",
  "  -c, --client     Be the client  (default=on)",
    0
};
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->host_given)
    write_into_file(outfile, "host", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "Vi:hc", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Be the host.  */
          ...
          if (update_arg((void *)&(args_info->host_flag), 0, &(args_info->host_given),
              &(local_args_info.host_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "host", 'h',
              additional_error))
            goto failure;
        
          break;
        case 'c':	/* Be the client.  */
